        ...
        <header className="bg-gray-100 border-b border-gray-200">
          ...
          <nav className="px-4">
            <ul className="flex border-b justify-center">
              <li className="mx-4">
                <button className="inline-block px-6 py-3 text-lg font-bold text-gray-500 hover:text-gray-700">
              ...
              <li className="mx-4">
                <button className="inline-block px-6 py-3 text-lg font-bold text-heineken-green border-b-2 border-heineken-green">
                  Pricing Simulator
                </button>
              </li>
            </ul>
